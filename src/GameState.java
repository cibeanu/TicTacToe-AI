...
public class GameState {
	 ...
	 * 
	 * Checks the rows, columns and diagonals for the winner and return true if the
	 * winner is found, otherwise returns false
	 *
	...
	/**
	 *
	 * Converts the boardState(represented as an array of Strings into a String
	 * matrix of boardSize * boardSize for the checkWinner function
	 *
	 * @param boardState boardState which needs to be converted to matrix
